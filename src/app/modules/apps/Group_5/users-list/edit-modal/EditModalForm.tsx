 ...
 let firstObj:modal = data[0]
  ...
  return (
    <div>
      ...
      <Row><Col><InputFelid placeholder='pG04Tx01' label='pG04Tx01' /></Col></Row>
      <Row><Col><InputFelid placeholder='pG04Tx02' label='pG04Tx02' /></Col></Row>
      <Row><Col><InputFelid placeholder='pG04Tx03' label='pG04Tx03' /></Col></Row>
      <Row><Col><InputFelid placeholder='pG04Tx04' label='pG04Tx04' /></Col></Row>
      <Row><Col><DropDwon/></Col></Row>
      <Row>
        <Col>
