...
import { TableModal } from '../table modal/Table'
 ...
 let firstObj:modal = data[0]
  ...
  return (
    <div>
       ...
       <Row>
        <Col xs={12} md={6}><InputFelid placeholder='pG04Tx03' label='pG04Tx03' /></Col>
        <Col xs={12} md={6}><InputFelid placeholder='pG04Tx04' label='pG04Tx04' /></Col>
       </Row>
       <Row><Col><DropDwon/></Col></Row>
      <Row>
        <Col>
