...
const GET_GETPG09 = `${API_URL_UNSTABLE}jobs/PG09`
 

const GetPg09 = (query: string): Promise<QueryResponse> => {
  return axios
    .get(`${GET_GETPG09}`)
...
export {getUsers, deleteUser, deleteSelectedUsers, getUserById, createUser, updateUser,GetPg09 }
