...
const GET_GETPG07 = `${API_URL_UNSTABLE}jobs/Pg07`
 

const GetPg07 = (query: string): Promise<QueryResponse> => {
  return axios
    .get(`${GET_GETPG07}`)
...
export {getUsers, deleteUser, deleteSelectedUsers, getUserById, createUser, updateUser,GetPg07 }
