...
const EditModalForm: FC<Props> = () => {
  ...
  console.log(PostPG4Tb02(firstObj?.pG04Md01Lb01a)); 
  ...
  return (
    <div>
      ...
      <Row><Col>{data?.length > 0 ? <Table pG04Md01Lb01a={firstObj?.pG04Md01Lb01a} PostPG4Tb02={PostPG4Tb02} tableData={data && data} /> : null}</Col></Row>
      <Row>
        <Col>
