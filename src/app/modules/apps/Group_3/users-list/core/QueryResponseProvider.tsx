...
import {GetFinPress,GetPG04Sw01} from './_requests'
...
const QueryResponseProvider: FC<WithChildren> = ({children}) => {
  ...
  const {isLoading,isFetching,isError,error,refetch,data: response,} = useQuery([`gourp3`, fetchPG04Sw01],() => {
     return fetchPG04Sw01 ? GetPG04Sw01(query) : GetFinPress(query)
    },
