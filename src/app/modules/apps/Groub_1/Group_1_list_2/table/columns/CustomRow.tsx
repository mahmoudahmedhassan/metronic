...
const CustomRow: FC<Props> = ({row,onRowSelected,setSelectedIdRow, rowID}) => {
  ...
  return (
    <tr
      ...
      onClick={() =>{ 
        ...
        setSelectedIdRow({value_1:row.cells[0].row.original.t101,value_2:row.cells[0].row.original.t102})
