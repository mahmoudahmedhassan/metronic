...
import {getUsers,GetFinPress} from './_requests'
...
const QueryResponseProvider: FC<WithChildren> = ({children}) => {
  ...
  const {isLoading,isFetching,isError,error,refetch,data: response,} = useQuery(`${QUERIES.USERS_LIST}-${query}`,() => {
      return GetFinPress(query)
    },
