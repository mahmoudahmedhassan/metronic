...
const UserEditModalForm: FC<Props> = ({user, isUserLoading}) => {
  ...
  // callback method called to return the multiply of two numbers
  const handleMultiplyNumbers = useCallback((x:number,y:number) => multiplyNumbers(x,y),[],)
  console.log(handleMultiplyNumbers(2, 4));
  console.log(handleMultiplyNumbers(2, 3));
  console.log(handleMultiplyNumbers(2, 4));
